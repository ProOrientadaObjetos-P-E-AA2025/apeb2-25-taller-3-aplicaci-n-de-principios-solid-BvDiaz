...
public class Principal {
    public static void main(String[] args) {
        ...
        Ciudad ciudad = new Ciudad("Quito");
        Persona persona = new Persona("Juan", "Perez", 30, "1712345678", ciudad);
        ...
        PagoLuzElectrica luzComercio = new PagoLuzElectrica(10.20, 200, 0.5, "Quito");
